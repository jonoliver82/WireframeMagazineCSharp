...
using WaterRipple.Services;
using WaterRipple.Views;
...
namespace WaterRipple
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            builder.RegisterType<WaterRippleForm>().As<IGameView>();
            builder.RegisterType<WaterRippleGame>().As<IWaterRippleGame>();
